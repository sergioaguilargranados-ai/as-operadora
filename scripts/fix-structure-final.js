...
// Eliminar el comentario {/* Footer */} suelto y los círculos flotantes mal ubicados
// que están DESPUÉS de </main>
const pattern = /\s*<\/main>\s*\n\s*\n\s*{\/\* Footer \*\/}\s*\n\s*\n\s*{\/\* C[íi]rculos flotantes[\s\S]*?<\/div>\s*\n/;
content = content.replace(pattern, '      </main>\n');

// Ahora buscar el footer real y agregar los círculos flotantes ANTES del footer
...
content = content.replace(footerPattern, floatingButtons + '\n$1');

fs.writeFileSync(filePath, content, 'utf8');
console.log('✅ Estructura corregida - círculos flotantes ahora en posición correcta (antes del footer)');
